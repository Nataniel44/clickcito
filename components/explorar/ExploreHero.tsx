...
export function ExploreHero({ searchTerm, setSearchTerm, activeRubro, setActiveRubro, onLocationClick, isLocating }: ExploreHeroProps) {
    return (
        <div className="max-w-4xl mx-auto mb-8 md:mb-12 px-2 sm:px-4 flex flex-col items-center">
            ...
            <div className="flex flex-col sm:flex-row gap-2 md:gap-3 mb-6 md:mb-8 w-full max-w-2xl px-2 sm:px-0">
                ...
                >
                    ...
                    {isLocating ? "Detectando..." : "En mi ciudad"}
                </button>
            </div>
