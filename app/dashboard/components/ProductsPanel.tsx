...
import { Eye, Package, Tag, Trash2, Plus, Edit } from "lucide-react";
        ...
        <div className="space-y-6 animate-in fade-in slide-in-from-bottom-4 duration-700">
            <div className="flex items-center justify-between mb-6">
                ...
                <div className="flex gap-2">
                    <button onClick={() => router.push(`/negocio/${user?.id_negocio}`)} className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gray-100 dark:bg-zinc-800 text-gray-900 dark:text-white text-xs font-black rounded-xl hover:bg-gray-200 dark:hover:bg-zinc-700 transition-colors">
